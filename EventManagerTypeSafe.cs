...
//Some examples: 
public class ReticleStartEvent : GameEvent
{
	public int id{ get; private set; }

	public ReticleStartEvent(int _id){
		this.id = _id;
	}
}

public class ReticleHitEvent : GameEvent 
{
	public int id{ get; private set; }

	public ReticleHitEvent(int _id){
		this.id = _id;
	}
}

public class ReticleEndEvent : GameEvent
{
	public ReticleEndEvent(){}	
}
